...
export const selectShopsLoading = (state: RootState) =>
  state.admin.shopsLoading;

export const selectAdminProducts = (state: RootState) => state.admin.products;
export const selectProductsTotal = (state: RootState) =>
  state.admin.productsTotal;
export const selectProductsPage = (state: RootState) =>
  state.admin.productsPage;
export const selectProductsPages = (state: RootState) =>
  state.admin.productsPages;
...
export const selectReviewsTotal = (state: RootState) =>
  state.admin.reviewsTotal;
export const selectReviewsPage = (state: RootState) => state.admin.reviewsPage;
export const selectReviewsPages = (state: RootState) =>
  state.admin.reviewsPages;
export const selectReviewsLoading = (state: RootState) =>
  state.admin.reviewsLoading;

export const selectAdminMutatingId = (state: RootState) =>
  state.admin.mutatingId;
export const selectLastResetPassword = (state: RootState) =>
  state.admin.lastResetPassword;
export const selectAdminError = (state: RootState) => state.admin.error;
export const selectAdminSuccessMessage = (state: RootState) =>
