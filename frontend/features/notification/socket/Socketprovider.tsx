...
/**
 * Mounts once in the root layout (via AppProvider). Handles:
 ...
 *  - "notification:new"   -> pushes into notificationSlice (bell badge) + toast,
 *                            covers order/offer/product/shop/feedback notifications
 *                            generically — one event, one handler, for every type
 */
export default function SocketProvider({ children }: SocketProviderProps) {
    ...
    useEffect(() => {
        ...
        // Sync the unread bell count once per connect (covers notifications
        // that arrived while the tab/socket was closed)
