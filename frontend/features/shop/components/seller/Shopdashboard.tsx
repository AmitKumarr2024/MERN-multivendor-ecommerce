    ...
    return (
        <div className="mx-auto max-w-7xl p-4 pb-10 sm:p-6">
            ...
            <div className="mb-4 flex items-center gap-3 sm:mb-6">
                ...
                <span
                    className={`shrink-0 inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-medium ${shop.isActive
                ...
                >
                    <span className="relative flex h-2 w-2 items-center justify-center">
                        {shop.isActive && (
                            <span className="absolute h-full w-full animate-ping rounded-full bg-success-text opacity-50" />
                        )}

                        <span
                            className={`relative h-1.5 w-1.5 rounded-full ${shop.isActive ? "bg-success-text" : "bg-muted"
                                }`}
                        />
                    </span>
            ...
            <div className="flex gap-6">
                ...
                <div className="min-w-0 flex-1">
                    ...
                    <div className="space-y-4 sm:space-y-5">
                        ...
                        {active === "team" && <StaffList shopId={shop._id} />}
                        {active === "khata" && (
                            <div className="space-y-4">
                                <KhataSettingsToggle shopId={shop._id} />
                                <KhataRequestsList shopId={shop._id} />
                            </div>
                        )}
...
function TeamIcon() {
    return (
        <svg viewBox="0 0 20 20" fill="none" className="h-4 w-4" aria-hidden="true">
            ...
            <path d="M2.5 16c.5-3 2-4.5 4.5-4.5s4 1.5 4.5 4.5M13 8a2 2 0 100-4 2 2 0 000 4zM11.5 11c2 .3 3.2 1.5 3.7 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        </svg>
    );
}
function KhataIcon() {
