...
export interface RoleNavConfig {
  ...
  /**
   * Extra menu items unique to this role,
   * shown between Profile and Orders.
   *
   * Icon is optional because some menu items
   * don't need an icon in the current Navbar.
   */
  extraMenuItems: (NavLinkItem & {
    icon?: "dashboard" | "shop" | "users";
  })[];
