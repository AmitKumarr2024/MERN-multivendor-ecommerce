...
// @desc    Update shop details (name, description, logo, banner, address, contact)
//          Note: custom slug/URL changes are handled separately - see shop.slug.controller.js
...
export const updateMyShop = async (req, res, next) => {
  try {
    ...
    const { shopName, description, logo, banner, address, contactPhone, contactEmail } = req.body;
...
// @desc    Toggle shop active/inactive (temporarily hide the whole dukan)
// @route   PATCH /api/shops/me/toggle-active
// @access  Private
