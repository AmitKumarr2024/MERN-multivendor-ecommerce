...
import {
  ...
  getShopBySlug,
  getMyShop,
} from "../controllers/read/shop.read.controller.js";
import {
  updateMyShop,
  toggleShopActive,
} from "../controllers/update/shop.update.controller.js";
import {
  checkSlugAvailability,
  updateShopSlug,
} from "../controllers/slug/shop.slug.controller.js";
import {
  updateBusinessHours,
  updateHolidayDates,
  checkShopIsOpen,
} from "../controllers/hours/shop.hours.controller.js";
...
router.put("/me", protect, validate(updateShopSchema), updateMyShop);
router.put("/me/slug", protect, validate(updateSlugSchema), updateShopSlug);
...
// Private - create shop
router.post("/", protect, validate(createShopSchema), createShop);

// Public - dukan page by custom URL slug (must be last, catches any remaining slug)
router.get("/:slug", getShopBySlug);
router.get("/:slug/is-open", checkShopIsOpen);
