...
} from "../../review/controllers/review.controller.js"; // 👈 NEW
...
// 👇 NEW - nested review routes, most specific first
...
router.patch("/:id/stock", protect, validate(updateStockSchema), updateProductStock);
...
router.put("/:id/variants/:variantId", protect, validate(updateVariantSchema), updateVariant);
